...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Parity\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Parity\\TypeCheck'), false);
    }
