<?php
namespace Icecave\Parity\TypeCheck\Exception;

final class UnexpectedArgumentValueException extends UnexpectedInputException
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Icecave\Parity\TypeCheck\TypeInspector $typeInspector = null)
    {
        if (null === $typeInspector) {
            $typeInspector = new \Icecave\Parity\TypeCheck\TypeInspector();
        }
